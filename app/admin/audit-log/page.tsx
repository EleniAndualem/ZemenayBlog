...
import { Shield, User, Calendar, Activity, Search, Filter, Clock, Eye, Trash2, Edit, Plus, Settings, LogOut, UserPlus, FileText, Database } from "lucide-react"
          ...
          return (
            ...
            >
              <div className="flex items-start gap-4">
                <div className={`p-3 rounded-xl ${getActionColor(log.action)}`}>
